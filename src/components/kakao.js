function Kakao() {
  return (
    <div className="overflow-y-auto my-[14px] h-[817px]">
      <div className="bg-white h-[1000px] w-[420px] relative">
        {/* //!상단바 */}
        <div className="fixed top-[105px] sm:top-[156px] md:top-[52px] flex justify-between items-center w-[420px] h-10 bg-white">
          {/* //!상단바 좌측 요소 */}
